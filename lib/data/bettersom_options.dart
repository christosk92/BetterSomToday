...
class SomOptions {
  ...
  static SomOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, SomOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = SomOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ModelBinding({
    Key key,
    this.initialModel = const SomOptions(),
    this.child,
  })  : assert(initialModel != null),
        super(key: key);

  final SomOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  ...
  void handleTimeDilation(SomOptions newModel) {
  ...
  void updateModel(SomOptions newModel) {
